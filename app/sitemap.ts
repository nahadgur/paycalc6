...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/statutory-changes`, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/itax-2026`, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/tax-relief`, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/statutory-deductions`, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/salary-breakdowns`, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/employment-situations`, changeFrequency: 'monthly' as const, priority: 0.8 },
    ...
    { url: `${baseUrl}/employer-guide`, changeFrequency: 'monthly' as const, priority: 0.7 },
