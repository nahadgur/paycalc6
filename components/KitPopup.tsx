...
export default function KitPopup() {
  ...
  return (
    <div className="animate-fadeIn fixed inset-x-4 bottom-4 z-[60] sm:inset-x-auto sm:right-5 sm:bottom-5 sm:w-[360px]">
      <div className="banner-shine relative overflow-hidden rounded-2xl bg-[#1a1412] p-5 text-[#fff] shadow-2xl shadow-black/30">
        <button
          type="button"
          onClick={dismiss}
          aria-label="Dismiss"
        ...
        <h3 className="editorial-h mt-3 pr-6 text-[20px] leading-tight">
        ...
        <Link
          href="/kit"
          onClick={dismiss}
          className="relative z-10 mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-brand px-5 py-3 text-sm font-bold text-[#fff] transition-colors hover:bg-brand-600"
        >
