...
export default function NavCalculators() {
  ...
  // Click-outside + Escape (covers the tap-to-open path on touch devices).
  useEffect(() => {
    if (!open) return
  ...
  return (
    ...
    >
      <button
        ...
        aria-expanded={open}
        aria-haspopup="true"
        className="flex items-center gap-1 text-[#555] hover:text-brand transition-colors text-[13px] font-medium py-2"
      >
        Calculators
