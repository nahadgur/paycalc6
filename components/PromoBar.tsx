...
// Slim site-wide promo for the kit. Goes straight to the Selar download.
// Dismissible, remembered in localStorage so returning visitors are not nagged.
// Bump the key version to re-show the bar after a change. Starts hidden on the
// server and appears after mount, which avoids a hydration mismatch for visitors
